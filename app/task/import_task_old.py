    ...
    try:
        ...
        for i in range(0, len(data_import), batch_size):
            ...
            for data_item in batch:
                ...
                error = hotmail_data.get("error", None) if hotmail_data else None
                ...
                browser_type = data_eoffice.get("browser", {}).get("browser_type") if data_eoffice else None
...
#         access_token = hotmail_data.get("access_token", None) if hotmail_data else None
#         refresh_token = hotmail_data.get("refresh_token", None) if hotmail_data else None
#         error = hotmail_data.get("error", None) if hotmail_data else None
#         completed = hotmail_data.get("Completed", None) if hotmail_data else None
